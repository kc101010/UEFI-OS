...
const char* to_string(uint64_t value){      //does not allow neg nums
    uint8_t size;
...
const char* to_string(int64_t value){       //allows neg nums
...
const char* to_string(double value, uint8_t decimalPlaces){       
    ...
    char* intPtr = (char*)to_string((int64_t)value); //give int in string
